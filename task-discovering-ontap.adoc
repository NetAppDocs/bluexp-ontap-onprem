...
If you decide to switch to the other discovery option, the on-prem system will be discovered as a separate working environment on the Canvas. If needed, you can then remove the other working environment.
