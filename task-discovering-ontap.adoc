...
+
<<Discover clusters using a Connector,Review the requirements and step-by-step instructions below>>.
...
+
<<Discover clusters directly,Review the requirements and step-by-step instructions below>>.
