...
Note that following about the on-premises ONTAP clusters that appear on the My estate page:
...
** If you log in to BlueXP with your NetApp Support Site account and navigate to the My estate page, BlueXP uses your NSS account to find the clusters that are associated with that account.

** If you log in to BlueXP with a cloud account and navigate to the My estate page, BlueXP prompts you to verify your email. If that email address is associated with a NetApp Support Site account, BlueXP uses that information to find the clusters that are associated with that account.

* BlueXP shows the ONTAP clusters that have successfully sent AutoSupport messages to NetApp.
