...
You can now discover NetApp ASA r2 systems in BlueXP when using BlueXP in standard mode or private mode. After you discover a NetApp ASA r2 system and open the working environment, you're brought directly to System Manager.
...
* https://docs.netapp.com/us-en/bluexp-setup-admin/us-en/concept-modes.html[Learn about BlueXP deployment modes^]
