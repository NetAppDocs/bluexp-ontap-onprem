...
Beginning with ONTAP 9.10.1, you can use System Manager (advanced view) to upgrade the ONTAP version image and hardware firmware.

* If you do _not_ have a Connector, you can choose to manually upgrade the version image and firmware from your local machine or from an accessible server. You can also choose to receive automatic upgrades to the firmware to stay up to date.   

* If you have a Connector you can choose to receive automatic upgrades to the firmware to stay up to date.
